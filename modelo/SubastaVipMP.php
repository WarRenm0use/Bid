...
//        echo $sql."<br>";
    ...
    function findbyCod($cod, $attr = null) {
        ...
        $sql = "SELECT S.ID_SVIP, S.MONTO_SUBASTA, S.INICIO_SUBASTA, S.N_RECARGA_BID, S.ESTADO_SUBASTA, S.COD_SUBASTA, U.ID_USUARIO, U.NICK_USUARIO, I.URL_IMAGEN, P.ID_PRODUCTO, P.NOM_PRODUCTO,
            ((S.DURACION_SUBASTA + S.RETRASO_SUBASTA) - ($now - S.INICIO_SUBASTA)) AS RESTO_TIEMPO_SEC,
            TIMEDIFF(
                from_unixtime(S.INICIO_SUBASTA + S.DURACION_SUBASTA + S.RETRASO_SUBASTA), 
                from_unixtime($now)
